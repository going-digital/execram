; "store" backend's actual Depack: routine - no compression at all, the
; payload already IS the code_data+reloc_stream bytes verbatim. Split out
; of stub.s for clarity - the single assembled stub_store binary serves
; both the default and overlap layouts (docs/format-spec.md §8b),
; stubs/common/runtime.i itself branching on FLAG_OVERLAP; Depack: never
